...
Aiming candidates one version forward ensures they sort above the release that
precedes them and below the release they become, and they are pre-releases.
"""
